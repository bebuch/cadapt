...
TEST(c_str_test, c_str) {
    CT_EXPECT_TRUE(is_equal("test"sv, c_str(null_term, "test")));
    EXPECT_FALSE(is_equal("te\0st"sv, c_str(null_term, "te\0st")));
    CT_EXPECT_TRUE(is_equal("test"sv, c_str("test")));
    EXPECT_THROW((void)is_equal("te\0st"sv, c_str("te\0st")), std::logic_error);

    CT_EXPECT_TRUE(is_equal(L"test"sv, c_str(null_term, L"test")));
    EXPECT_FALSE(is_equal(L"te\0st"sv, c_str(null_term, L"te\0st")));
    CT_EXPECT_TRUE(is_equal(L"test"sv, c_str(L"test")));
    EXPECT_THROW((void)is_equal(L"te\0st"sv, c_str(L"te\0st")), std::logic_error);

    CT_EXPECT_TRUE(is_equal(U"test"sv, c_str(null_term, U"test")));
    EXPECT_FALSE(is_equal(U"te\0st"sv, c_str(null_term, U"te\0st")));
    ...
    CT_EXPECT_TRUE(is_equal(u8"test"sv, c_str(null_term, u8"test")));
    EXPECT_FALSE(is_equal(u8"te\0st"sv, c_str(null_term, u8"te\0st")));
...
TEST(c_str_test, std_string) {
    CT_EXPECT_TRUE(is_equal("test"sv, c_str(null_term, "test"s)));
    EXPECT_FALSE(is_equal("te\0st"sv, c_str(null_term, "te\0st"s)));
    CT_EXPECT_TRUE(is_equal("test"sv, c_str("test"s)));
    EXPECT_THROW((void)is_equal("te\0st"sv, c_str("te\0st"s)), std::logic_error);

    CT_EXPECT_TRUE(is_equal(L"test"sv, c_str(null_term, L"test"s)));
    EXPECT_FALSE(is_equal(L"te\0st"sv, c_str(null_term, L"te\0st"s)));
    CT_EXPECT_TRUE(is_equal(L"test"sv, c_str(L"test"s)));
    EXPECT_THROW((void)is_equal(L"te\0st"sv, c_str(L"te\0st"s)), std::logic_error);

    CT_EXPECT_TRUE(is_equal(U"test"sv, c_str(null_term, U"test"s)));
    EXPECT_FALSE(is_equal(U"te\0st"sv, c_str(null_term, U"te\0st"s)));
    ...
    CT_EXPECT_TRUE(is_equal(u8"test"sv, c_str(null_term, u8"test"s)));
    EXPECT_FALSE(is_equal(u8"te\0st"sv, c_str(null_term, u8"te\0st"s)));
...
TEST(c_str_test, std_string_view) {
    CT_EXPECT_TRUE(is_equal("test"sv, c_str(null_term, "test"sv)));
    EXPECT_FALSE(is_equal("te\0st"sv, c_str(null_term, "te\0st"sv)));
    CT_EXPECT_TRUE(is_equal("test"sv, c_str("test"sv)));
    EXPECT_THROW((void)is_equal("te\0st"sv, c_str("te\0st"sv)), std::logic_error);

    CT_EXPECT_TRUE(is_equal(L"test"sv, c_str(null_term, L"test"sv)));
    EXPECT_FALSE(is_equal(L"te\0st"sv, c_str(null_term, L"te\0st"sv)));
    ...
    CT_EXPECT_TRUE(is_equal(U"test"sv, c_str(null_term, U"test"sv)));
    EXPECT_FALSE(is_equal(U"te\0st"sv, c_str(null_term, U"te\0st"sv)));
    ...
    CT_EXPECT_TRUE(is_equal(u"test"sv, c_str(null_term, u"test"sv)));
    CT_EXPECT_FALSE(is_equal(u"te\0st"sv, c_str(null_term, u"te\0st"sv)));
    CT_EXPECT_TRUE(is_equal(u"test"sv, c_str(u"test"sv)));
    EXPECT_THROW((void)is_equal(u"te\0st"sv, c_str(u"te\0st"sv)), std::logic_error);

    CT_EXPECT_TRUE(is_equal(u8"test"sv, c_str(null_term, u8"test"sv)));
    EXPECT_FALSE(is_equal(u8"te\0st"sv, c_str(null_term, u8"te\0st"sv)));
...
TEST(c_str_test, c_str_view) {
    CT_EXPECT_TRUE(is_equal("test"sv, c_str(null_term, "test"_sv)));
    EXPECT_FALSE(is_equal("te\0st"sv, c_str(null_term, basic_c_str_view(null_term, "te\0st"))));
    ...
    CT_EXPECT_TRUE(is_equal(L"test"sv, c_str(null_term, L"test"_sv)));
    EXPECT_FALSE(is_equal(L"te\0st"sv, c_str(null_term, basic_c_str_view(null_term, L"te\0st"))));
    ...
    CT_EXPECT_TRUE(is_equal(U"test"sv, c_str(null_term, U"test"_sv)));
    EXPECT_FALSE(is_equal(U"te\0st"sv, c_str(null_term, basic_c_str_view(null_term, U"te\0st"))));
    ...
    CT_EXPECT_TRUE(is_equal(u8"test"sv, c_str(null_term, u8"test"_sv)));
    EXPECT_FALSE(is_equal(u8"te\0st"sv, c_str(null_term, basic_c_str_view(null_term, u8"te\0st"))));
...
TEST(c_str_test, qstring) {
    EXPECT_TRUE(is_equal("test"sv, c_str(null_term, QString::fromStdString("test"s))));
    EXPECT_FALSE(is_equal("te\0st"sv, c_str(null_term, QString::fromStdString("te\0st"s))));
    ...
    EXPECT_TRUE(is_equal(L"test"sv, c_str<wchar_t>(null_term, QString::fromStdString("test"s))));
    EXPECT_FALSE(is_equal(L"te\0st"sv, c_str<wchar_t>(null_term, QString::fromStdString("te\0st"s))));
    ...
    EXPECT_TRUE(is_equal(U"test"sv, c_str<char32_t>(null_term, QString::fromStdString("test"s))));
    EXPECT_FALSE(is_equal(U"te\0st"sv, c_str<char32_t>(null_term, QString::fromStdString("te\0st"s))));
    ...
    EXPECT_TRUE(is_equal(u"test"sv, c_str<char16_t>(null_term, QString::fromStdString("test"s))));
    EXPECT_FALSE(is_equal(u"te\0st"sv, c_str<char16_t>(null_term, QString::fromStdString("te\0st"s))));
