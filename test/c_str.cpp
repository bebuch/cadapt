...
TEST(c_str_test, c_str) {
    ...
    CT_EXPECT_FALSE(is_equal("te\0st"sv, unverified_c_str("te\0st")));
    ...
    CT_EXPECT_FALSE(is_equal(L"te\0st"sv, unverified_c_str(L"te\0st")));
    ...
    CT_EXPECT_FALSE(is_equal(U"te\0st"sv, unverified_c_str(U"te\0st")));
    ...
    CT_EXPECT_FALSE(is_equal(u8"te\0st"sv, unverified_c_str(u8"te\0st")));
...
TEST(c_str_test, std_string) {
    ...
    CT_EXPECT_FALSE(is_equal("te\0st"sv, unverified_c_str("te\0st"s)));
    ...
    CT_EXPECT_FALSE(is_equal(L"te\0st"sv, unverified_c_str(L"te\0st"s)));
    ...
    CT_EXPECT_FALSE(is_equal(U"te\0st"sv, unverified_c_str(U"te\0st"s)));
    ...
    CT_EXPECT_FALSE(is_equal(u8"te\0st"sv, unverified_c_str(u8"te\0st"s)));
...
TEST(c_str_test, std_string_view) {
    ...
    CT_EXPECT_FALSE(is_equal("te\0st"sv, unverified_c_str("te\0st"sv)));
    ...
    CT_EXPECT_FALSE(is_equal(L"te\0st"sv, unverified_c_str(L"te\0st"sv)));
    ...
    CT_EXPECT_FALSE(is_equal(u8"te\0st"sv, unverified_c_str(u8"te\0st"sv)));
